...
#
#   This nbf converter is custom adjusted for BrgHBTile, which lacks dmem
#   and whose icache cannot be initialized.
...
class NBF:
  ...
  def dump(self):
    # self.config_tile_group()  # BrgHBTile doesn't have CSR space in mem
    # self.init_icache()        # BrgHBTile's icache cannot be initialized
    # self.init_dmem()          # BrgHBTile does not have dmem
    assert len(self.dmem_data.keys()) == 0, ".dmem section must be empty"
