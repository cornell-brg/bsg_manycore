...
// PyMTL BitStruct CgraFUMsg_33__bca7feb9182334d7 Definition
typedef struct packed {
  logic [32:0] opd_a;
  logic [32:0] opd_b;
  logic [32:0] opd_rf;
  logic [0:0] is_faking_opA;
  logic [0:0] is_faking_opB;
} CgraFUMsg_33__bca7feb9182334d7;

// PyMTL BitStruct CgraFUOutMsg_33__result_33__is_opd_bool_true_1 Definition
typedef struct packed {
  logic [32:0] result;
  logic [0:0] is_opd_bool_true;
} CgraFUOutMsg_33__result_33__is_opd_bool_true_1;

// PyMTL BitStruct CgraLLFUMsg_33__opd_a_33__opd_b_33__opd_rf_33 Definition
typedef struct packed {
  logic [32:0] opd_a;
  logic [32:0] opd_b;
  logic [32:0] opd_rf;
} CgraLLFUMsg_33__opd_a_33__opd_b_33__opd_rf_33;

// PyMTL BitStruct CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 Definition
typedef struct packed {
  logic [32:0] result;
  logic [32:0] opd_b;
  logic [32:0] opd_rf;
} CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33;
...
// BSG AND-reduce module that instantiates hardened cells from GF14 PDK
...
(
  ...
  localparam logic [0:0] __const__FIRE_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CE_e_0__ctrl_is_PE_init_addr  = 1'd1;
  logic [1:0] PE_init_state;
  logic [0:0] ce_ctrl_unused;
  ...
  logic [1:0] next_num_requested;
  logic [3:0] next_num_sent_cfgs;
  logic [0:0] next_reg_mem_rdata_en;
  ...
  //   if s.cfg_init:
  //     s.next_num_sent_cfgs @= 0
  //   elif s.cfg_out_val:
  //     s.next_num_sent_cfgs @= s.num_sent_cfgs + 1
  
  always_comb begin : CE_ctrl_next_num_sent_cfgs
    next_num_sent_cfgs = num_sent_cfgs;
    if ( cfg_init ) begin
      next_num_sent_cfgs = 4'd0;
    end
    else if ( cfg_out_val ) begin
      next_num_sent_cfgs = num_sent_cfgs + 4'd1;
    end
  end
  ...
  //   if s.mmaster_req_en & (s.num_requested == p.cfg_nwords-1):
  //     s.next_num_requested @= 0
  //   elif s.mmaster_req_en:
  //     s.next_num_requested @= s.num_requested + 1
  
  always_comb begin : CE_next_num_requested
    next_num_requested = num_requested;
    if ( mmaster_req_en & ( num_requested == ( 2'd1 - 2'd1 ) ) ) begin
      next_num_requested = 2'd0;
    end
    else if ( mmaster_req_en ) begin
      next_num_requested = num_requested + 2'd1;
    end
  end
  ...
  //   if s.cfg_init:
  //     s.next_reg_mem_rdata_en @= 1
  //   elif s.mem_resp_en:
  //     s.next_reg_mem_rdata_en @= s.shift_reg_pt_map_next
  
  always_comb begin : CE_next_reg_mem_rdata_en
    next_reg_mem_rdata_en = reg_mem_rdata_en;
    if ( cfg_init ) begin
      next_reg_mem_rdata_en = 1'd1;
    end
    else if ( mem_resp_en ) begin
      next_reg_mem_rdata_en = shift_reg_pt_map_next;
    end
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_CE_e_0__ctrl_is_PE_init_addr
    is_PE_init_addr = ( ( PE_init_state == 2'( __const__FIRE_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CE_e_0__ctrl_is_PE_init_addr ) ) & ( ~mmaster_req_en ) ) | ( next_PE_init_state == 2'( __const__FIRE_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CE_e_0__ctrl_is_PE_init_addr ) );
  end
  ...
  //     s.num_sent_cfgs <<= 0
  //   else:
  //     s.num_sent_cfgs <<= s.next_num_sent_cfgs
  ...
  always_ff @(posedge clk) begin : CE_ctrl_count_sent
    if ( reset ) begin
      ...
      num_sent_cfgs <= next_num_sent_cfgs;
  end
  ...
  //     s.num_requested <<= 0
  //   else:
  //     s.num_requested <<= s.next_num_requested
  ...
  always_ff @(posedge clk) begin : CE_num_requested_r
    if ( reset ) begin
      ...
      num_requested <= next_num_requested;
  end
  ...
  //   else:
  //     s.reg_mem_rdata_en <<= s.next_reg_mem_rdata_en
  
  always_ff @(posedge clk) begin : CE_out_reg_mem_rdata_en_r
    if ( reset ) begin
      reg_mem_rdata_en <= 1'd1;
    end
    else
      reg_mem_rdata_en <= next_reg_mem_rdata_en;
  end
  ...
  assign is_cfg_sent = cfg_out_val;
...
(
  ...
  //   if s.cfg_reset:
  //     s.next_target_x_cord @= s.initial_target_x_cord
  //   elif s.is_cfg_sent:
  //     s.next_target_x_cord @= s.target_x_cord+1
  
  always_comb begin : next_target_x_cord_wire
    next_target_x_cord = target_x_cord;
    if ( cfg_reset ) begin
      next_target_x_cord = initial_target_x_cord;
    end
    else if ( is_cfg_sent ) begin
      next_target_x_cord = target_x_cord + 4'd1;
    end
  end
  ...
  //   else:
  //     s.target_x_cord <<= s.next_target_x_cord
  ...
  always_ff @(posedge clk) begin : target_x_cord_ff
    if ( reset ) begin
      ...
      target_x_cord <= next_target_x_cord;
  end
...
(
  input  logic [0:0] clk ,
  input  logic [0:0] en ,
  input  logic [37:0] in_ ,
  output logic [37:0] out ,
  input  logic [0:0] reset 
);
  localparam logic [0:0] __const__reset_value_at_up_regenrst  = 1'd0;
  ...
  always_ff @(posedge clk) begin : up_regenrst
    if ( reset ) begin
      out <= 38'( __const__reset_value_at_up_regenrst );
    end
    else if ( en ) begin
      out <= in_;
    end
...
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  output logic [37:0] deq__msg  ,
  output logic [0:0] deq__val  ,
  input logic [37:0] enq__msg  ,
  ...
  logic [37:0] ele__in_;
  logic [37:0] ele__out;
  logic [0:0] ele__reset;

  RegEnRst__Type_Bits38__reset_value_0 ele
  (
    .clk( ele__clk ),
    .en( ele__en ),
    .in_( ele__in_ ),
  ...
  logic [0:0] full__in_;
  logic [0:0] full__out;
  logic [0:0] full__reset;

  RegRst__Type_Bits1__reset_value_0 full
  (
    .clk( full__clk ),
    .in_( full__in_ ),
    .out( full__out ),
  ...
  assign full__clk = clk;
  assign full__reset = reset;
  assign ele__clk = clk;
  assign ele__reset = reset;
  assign ele__en = enq__val;
  assign ele__in_ = enq__msg;
  assign deq__msg = ele__out;
  assign deq__val = full__out;
...
(
  ...
  always_comb begin : upblk_output_no_accept
    enq_rdy = ~full;
    deq_val = ~empty;
    wen = enq_val & enq_rdy;
  end
  ...
  always_ff @(posedge clk) begin : upblk_r_ptr_no_clear
    if ( reset ) begin
  ...
  always_ff @(posedge clk) begin : upblk_w_ptr_no_clear
    if ( reset ) begin
...
(
  ...
  output logic [32:0] rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  logic [32:0] wdata [0:0],
...
(
  input  logic [0:0] clk ,
  output logic [32:0] deq_msg ,
  input  logic [32:0] enq_msg ,
  ...
  logic [32:0] queue__rdata [0:0];
  logic [0:0] queue__reset;
  logic [0:0] queue__waddr [0:0];
  logic [32:0] queue__wdata [0:0];
  logic [0:0] queue__wen [0:0];

  RegisterFile__20535936df5a8c95 queue
  (
    .clk( queue__clk ),
    .raddr( queue__raddr ),
    .rdata( queue__rdata ),
...
(
  ...
  output logic [0:0] is_empty ,
  input  logic [0:0] reset ,
  output logic [32:0] deq__msg  ,
  input logic [0:0] deq__rdy  ,
  output logic [0:0] deq__val  ,
  input logic [32:0] enq__msg  ,
  ...
  logic [32:0] dpath__enq_msg;
  logic [0:0] dpath__raddr;
  logic [0:0] dpath__reset;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  ValRdyNormalQueuePow2DpathRTL__EntryType_Bits33__num_entries_2 dpath
  (
    .clk( dpath__clk ),
...
(
  ...
  input logic [37:0] cfg_in__msg  ,
  input logic [0:0] cfg_in__val  ,
  output logic [37:0] cfg_out__msg  ,
  output logic [0:0] cfg_out__val  ,
  input logic [32:0] in___msg  ,
  ...
  logic [37:0] cfg_q__deq__msg;
  logic [0:0] cfg_q__deq__val;
  logic [37:0] cfg_q__enq__msg;
  logic [0:0] cfg_q__enq__val;

  ZeroBackPressureBuffer__Type_Bits38 cfg_q
  (
    .clk( cfg_q__clk ),
    .reset( cfg_q__reset ),
  ...
  logic [32:0] in_q__deq__msg;
  logic [0:0] in_q__deq__rdy;
  logic [0:0] in_q__deq__val;
  logic [32:0] in_q__enq__msg;
  logic [0:0] in_q__enq__rdy;
  logic [0:0] in_q__enq__val;

  ValRdyNormalQueuePow2RTL__140d67166b825442 in_q
  (
    .clk( in_q__clk ),
...
(
  ...
  always_comb begin : comb_logic
    if ( fn == 4'd0 ) begin
      ...
      out = a_gt_b ? 33'd1 : 33'd0;
    end
    else if ( fn == 4'd12 ) begin
      out = ( a_gt_b | a_eq_b ) ? 33'd1 : 33'd0;
    end
    else if ( fn == 4'd13 ) begin
      out = a_sgt_b ? 33'd1 : 33'd0;
    end
    else if ( fn == 4'd14 ) begin
      out = ( a_sgt_b | a_eq_b ) ? 33'd1 : 33'd0;
    end
    else
      out = 33'd0;
  end
...
(
  ...
  logic [0:0] r_ptr;
  logic [1:0] r_ptr_with_wrapbit;
  logic [1:0] r_ptr_with_wrapbit_n;
  logic [0:0] w_ptr;
  logic [1:0] w_ptr_with_wrapbit;
  ...
  //   if s.clear:
  //     s.r_ptr_with_wrapbit_n @= 0
  //   elif s.deq_val & s.deq_rdy:
  //     s.r_ptr_with_wrapbit_n @= s.r_ptr_with_wrapbit + 1
  
  always_comb begin : upblk_r_ptr_en_clear_next
    r_ptr_with_wrapbit_n = r_ptr_with_wrapbit;
    if ( clear ) begin
      r_ptr_with_wrapbit_n = 2'd0;
    end
    else if ( deq_val & deq_rdy ) begin
      r_ptr_with_wrapbit_n = r_ptr_with_wrapbit + 2'd1;
    end
  end
  ...
  //   if s.clear:
  //     s.w_ptr_with_wrapbit_n @= 0
  //   elif s.enq_val & s.enq_rdy:
  //     s.w_ptr_with_wrapbit_n @= s.w_ptr_with_wrapbit + 1
  
  always_comb begin : upblk_w_ptr_en_clear_next
    w_ptr_with_wrapbit_n = w_ptr_with_wrapbit;
    if ( clear ) begin
      w_ptr_with_wrapbit_n = 2'd0;
    end
    else if ( enq_val & enq_rdy ) begin
      w_ptr_with_wrapbit_n = w_ptr_with_wrapbit + 2'd1;
    end
  end
  ...
  //     s.r_ptr_with_wrapbit <<= 0
  //   else:
  //     s.r_ptr_with_wrapbit <<= s.r_ptr_with_wrapbit_n
  
  always_ff @(posedge clk) begin : upblk_r_ptr_en_clear
    if ( reset ) begin
      r_ptr_with_wrapbit <= 2'd0;
    end
    else
      r_ptr_with_wrapbit <= r_ptr_with_wrapbit_n;
  end
  ...
  //     s.w_ptr_with_wrapbit <<= 0
  //   else:
  //     s.w_ptr_with_wrapbit <<= s.w_ptr_with_wrapbit_n
  
  always_ff @(posedge clk) begin : upblk_w_ptr_en_clear
    if ( reset ) begin
      w_ptr_with_wrapbit <= 2'd0;
    end
    else
      w_ptr_with_wrapbit <= w_ptr_with_wrapbit_n;
  end
...
(
  input  logic [0:0] clk ,
  input  logic [0:0] raddr [0:0],
  output CgraFUMsg_33__bca7feb9182334d7 rdata [0:0],
  input  logic [0:0] reset ,
  input  logic [0:0] waddr [0:0],
  input  CgraFUMsg_33__bca7feb9182334d7 wdata [0:0],
  input  logic [0:0] wen [0:0]
);
  localparam logic [0:0] __const__rd_ports_at_up_rf_read  = 1'd1;
  localparam logic [0:0] __const__wr_ports_at_up_rf_write  = 1'd1;
...
(
  input  logic [0:0] clk ,
  output CgraFUMsg_33__bca7feb9182334d7 deq_msg ,
  input  CgraFUMsg_33__bca7feb9182334d7 enq_msg ,
  input  logic [0:0] raddr ,
  input  logic [0:0] reset ,
  input  logic [0:0] waddr ,
  input  logic [0:0] wen 
  ...
  logic [0:0] queue__clk;
  logic [0:0] queue__raddr [0:0];
  CgraFUMsg_33__bca7feb9182334d7 queue__rdata [0:0];
  logic [0:0] queue__reset;
  logic [0:0] queue__waddr [0:0];
  CgraFUMsg_33__bca7feb9182334d7 queue__wdata [0:0];
  logic [0:0] queue__wen [0:0];

  RegisterFile__a9c31e768e5c5fbe queue
  (
    .clk( queue__clk ),
    .raddr( queue__raddr ),
    .rdata( queue__rdata ),
...
(
  ...
  output logic [0:0] is_empty ,
  input  logic [0:0] reset ,
  output CgraFUMsg_33__bca7feb9182334d7 deq__msg  ,
  input logic [0:0] deq__rdy  ,
  output logic [0:0] deq__val  ,
  input CgraFUMsg_33__bca7feb9182334d7 enq__msg  ,
  output logic [0:0] enq__rdy  ,
  input logic [0:0] enq__val  
);
  //-------------------------------------------------------------
  ...
  ValRdyNormalQueuePow2CtrlRTL__650d7616a012fd9a ctrl
  (
    .clear( ctrl__clear ),
    .clk( ctrl__clk ),
    .deq_rdy( ctrl__deq_rdy ),
  ...
  logic [0:0] dpath__clk;
  CgraFUMsg_33__bca7feb9182334d7 dpath__deq_msg;
  CgraFUMsg_33__bca7feb9182334d7 dpath__enq_msg;
  logic [0:0] dpath__raddr;
  logic [0:0] dpath__reset;
  logic [0:0] dpath__waddr;
  logic [0:0] dpath__wen;

  ValRdyNormalQueuePow2DpathRTL__b133560d3b930c66 dpath
  (
    .clk( dpath__clk ),
    .deq_msg( dpath__deq_msg ),
    .enq_msg( dpath__enq_msg ),
...
// Wrapper of placeholder MulAddRecFN__expWidth_8__sigWidth_24__imulEn_0
//-----------------------------------------------------------

`ifndef MULADDRECFN__EXPWIDTH_8__SIGWIDTH_24__IMULEN_0
`define MULADDRECFN__EXPWIDTH_8__SIGWIDTH_24__IMULEN_0

module MulAddRecFN__expWidth_8__sigWidth_24__imulEn_0
(
  input logic reset,
  input logic clk,
...
`endif /* MULADDRECFN__EXPWIDTH_8__SIGWIDTH_24__IMULEN_0 */
...
(
  ...
  input  logic [32:0] c ,
  input  logic [0:0] clk ,
  input  logic [0:0] control ,
  output logic [4:0] exceptionFlags ,
  input  logic [2:0] op ,
  output logic [32:0] out ,
  output logic [31:0] out_imul ,
  input  logic [0:0] reset ,
  input  logic [2:0] roundingMode 
);
  localparam logic [15:0] __const__conv_pad_zeros_at_hf_fmadd_conv  = 16'd0;
  logic [32:0] a_fp32;
  logic [32:0] b_fp32;
  //-------------------------------------------------------------
  // Component hardfloat_fmadd
  //-------------------------------------------------------------

  logic [32:0] hardfloat_fmadd__a;
  logic [32:0] hardfloat_fmadd__b;
  logic [32:0] hardfloat_fmadd__c;
  logic [0:0] hardfloat_fmadd__clk;
  logic [0:0] hardfloat_fmadd__control;
  logic [4:0] hardfloat_fmadd__exceptionFlags;
  logic [2:0] hardfloat_fmadd__op;
  logic [32:0] hardfloat_fmadd__out;
  logic [31:0] hardfloat_fmadd__out_imul;
  logic [0:0] hardfloat_fmadd__reset;
  logic [2:0] hardfloat_fmadd__roundingMode;

  MulAddRecFN__expWidth_8__sigWidth_24__imulEn_0 hardfloat_fmadd
  (
    .a( hardfloat_fmadd__a ),
    .b( hardfloat_fmadd__b ),
    .c( hardfloat_fmadd__c ),
    .clk( hardfloat_fmadd__clk ),
    .control( hardfloat_fmadd__control ),
    .exceptionFlags( hardfloat_fmadd__exceptionFlags ),
    .op( hardfloat_fmadd__op ),
    .out( hardfloat_fmadd__out ),
    .out_imul( hardfloat_fmadd__out_imul ),
    .reset( hardfloat_fmadd__reset ),
    .roundingMode( hardfloat_fmadd__roundingMode )
  );

  //-------------------------------------------------------------
  // End of component hardfloat_fmadd
  //-------------------------------------------------------------
  ...
  always_comb begin : hf_fmadd_conv
    a_fp32 = { a, 16'( __const__conv_pad_zeros_at_hf_fmadd_conv ) };
    b_fp32 = { b, 16'( __const__conv_pad_zeros_at_hf_fmadd_conv ) };
  end

  assign hardfloat_fmadd__clk = clk;
  assign hardfloat_fmadd__reset = reset;
  assign hardfloat_fmadd__control = control;
  assign hardfloat_fmadd__op = op;
  assign hardfloat_fmadd__a = a_fp32;
  assign hardfloat_fmadd__b = b_fp32;
  assign hardfloat_fmadd__c = c;
  assign hardfloat_fmadd__roundingMode = roundingMode;
  assign out = hardfloat_fmadd__out;
  assign exceptionFlags = hardfloat_fmadd__exceptionFlags;
  assign out_imul = hardfloat_fmadd__out_imul;
...
(
  input  logic [0:0] clk ,
  input  logic [0:0] en ,
  input  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 in_ ,
  output CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 out ,
  input  logic [0:0] reset 
);
...
(
  input  logic [0:0] clk ,
  input  logic [0:0] reset ,
  output CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 deq__msg  ,
  input logic [0:0] deq__rdy  ,
  output logic [0:0] deq__val  ,
  input CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 enq__msg  ,
  output logic [0:0] enq__rdy  ,
  input logic [0:0] enq__val  
);
  logic [0:0] full;
  ...
  logic [0:0] buffer__en;
  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 buffer__in_;
  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 buffer__out;
  logic [0:0] buffer__reset;

  RegEn__Type_CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 buffer
  (
    .clk( buffer__clk ),
    .en( buffer__en ),
    .in_( buffer__in_ ),
  ...
  always_comb begin : up_pipeq_full
    buffer__en = enq__val & enq__rdy;
    next_full = enq__val | ( full & ( ~deq__rdy ) );
  end
  ...
  always_comb begin : up_pipeq_set_enq_rdy
    enq__rdy = ( ~full ) | deq__rdy;
  end
  ...
  always_ff @(posedge clk) begin : up_full
    if ( reset ) begin
      full <= 1'd0;
    end
    else
  ...
  assign deq__msg = buffer__out;
  assign buffer__in_ = enq__msg;
  assign deq__val = full;
...
(
  ...
  input  logic [0:0] reset ,
  input CgraLLFUMsg_33__opd_a_33__opd_b_33__opd_rf_33 in___msg  ,
  output logic [0:0] in___rdy  ,
  input logic [0:0] in___val  ,
  output CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 out__msg  ,
  input logic [0:0] out__rdy  ,
  output logic [0:0] out__val  
);
  localparam logic [32:0] __const__FMADD_ONE_at_llfu_input_gen  = 33'd2147483648;
  localparam logic [32:0] __const__FMADD_ZERO_at_llfu_input_gen  = 33'd0;
  logic [32:0] fmadd_comb_out;
  logic [2:0] fmadd_op;
  logic [2:0] in_flight;
  logic [32:0] op_A;
  logic [32:0] op_B;
  ...
  logic [16:0] fmadd__b;
  logic [32:0] fmadd__c;
  logic [0:0] fmadd__clk;
  logic [0:0] fmadd__control;
  logic [4:0] fmadd__exceptionFlags;
  logic [2:0] fmadd__op;
  logic [32:0] fmadd__out;
  logic [31:0] fmadd__out_imul;
  logic [0:0] fmadd__reset;
  logic [2:0] fmadd__roundingMode;

  MulAddBFRecFN__051aa469b6846160 fmadd
  (
    .a( fmadd__a ),
    .b( fmadd__b ),
    .c( fmadd__c ),
    .clk( fmadd__clk ),
    .control( fmadd__control ),
    .exceptionFlags( fmadd__exceptionFlags ),
    .op( fmadd__op ),
    .out( fmadd__out ),
    .out_imul( fmadd__out_imul ),
    .reset( fmadd__reset ),
    .roundingMode( fmadd__roundingMode )
  );

  //-------------------------------------------------------------
  // End of component fmadd
  //-------------------------------------------------------------
  ...
  logic [0:0] q__clk [0:2];
  logic [0:0] q__reset [0:2];
  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 q__deq__msg [0:2];
  logic [0:0] q__deq__rdy [0:2];
  logic [0:0] q__deq__val [0:2];
  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 q__enq__msg [0:2];
  logic [0:0] q__enq__rdy [0:2];
  logic [0:0] q__enq__val [0:2];

  PipeQueue1RTL__0c116bc52e365ed0 q__0
  (
    .clk( q__clk[0] ),
    .reset( q__reset[0] ),
    .deq__msg( q__deq__msg[0] ),
    .deq__rdy( q__deq__rdy[0] ),
    .deq__val( q__deq__val[0] ),
    .enq__msg( q__enq__msg[0] ),
    .enq__rdy( q__enq__rdy[0] ),
    .enq__val( q__enq__val[0] )
  );

  PipeQueue1RTL__0c116bc52e365ed0 q__1
  (
    .clk( q__clk[1] ),
    .reset( q__reset[1] ),
    .deq__msg( q__deq__msg[1] ),
    .deq__rdy( q__deq__rdy[1] ),
    .deq__val( q__deq__val[1] ),
    .enq__msg( q__enq__msg[1] ),
    .enq__rdy( q__enq__rdy[1] ),
    .enq__val( q__enq__val[1] )
  );

  PipeQueue1RTL__0c116bc52e365ed0 q__2
  (
    .clk( q__clk[2] ),
    .reset( q__reset[2] ),
    .deq__msg( q__deq__msg[2] ),
    .deq__rdy( q__deq__rdy[2] ),
    .deq__val( q__deq__val[2] ),
    .enq__msg( q__enq__msg[2] ),
    .enq__rdy( q__enq__rdy[2] ),
    .enq__val( q__enq__val[2] )
  );

  //-------------------------------------------------------------
  // End of component q[0:2]
  //-------------------------------------------------------------
  ...
  //   s.op_B @= s.in_.msg.opd_b
  //   s.op_C @= s.in_.msg.opd_rf
  //   s.fmadd_op @= FMADDOp.PM_PB
  //   s.fmadd_comb_out @= s.out_fp
  //   # s.fmadd_op @= FMADDOp.IMUL
  //   # s.fmadd_comb_out @= sext( s.out_imul, p.dpath_width )
  // 
  //   if s.fn == LLFUOp.FADD:
  //     s.op_A @= s.in_.msg.opd_a
  //     s.op_B @= FMADD_ONE
  //     s.op_C @= s.in_.msg.opd_b
  //     s.fmadd_op @= FMADDOp.PM_PB
  //     s.fmadd_comb_out @= s.out_fp
  // 
  //   elif s.fn == LLFUOp.FSUB:
  //     s.op_A @= s.in_.msg.opd_a
  //     s.op_B @= FMADD_ONE
  //     s.op_C @= s.in_.msg.opd_b
  //     s.fmadd_op @= FMADDOp.PM_NB
  //     s.fmadd_comb_out @= s.out_fp
  // 
  //   elif s.fn == LLFUOp.FMUL:
  //     s.op_A @= s.in_.msg.opd_a
  //     s.op_B @= s.in_.msg.opd_b
  //     s.op_C @= FMADD_ZERO
  //     s.fmadd_op @= FMADDOp.PM_PB
  ...
  always_comb begin : llfu_input_gen
    op_A = in___msg.opd_a;
    op_B = in___msg.opd_b;
    op_C = in___msg.opd_rf;
    fmadd_op = 3'd0;
    fmadd_comb_out = out_fp;
    if ( fn == 3'd0 ) begin
      op_A = in___msg.opd_a;
      op_B = 33'( __const__FMADD_ONE_at_llfu_input_gen );
      op_C = in___msg.opd_b;
      fmadd_op = 3'd0;
      fmadd_comb_out = out_fp;
    end
    else if ( fn == 3'd1 ) begin
      op_A = in___msg.opd_a;
      op_B = 33'( __const__FMADD_ONE_at_llfu_input_gen );
      op_C = in___msg.opd_b;
      fmadd_op = 3'd1;
    ...
    else if ( fn == 3'd2 ) begin
      op_A = in___msg.opd_a;
      op_B = in___msg.opd_b;
      op_C = 33'( __const__FMADD_ZERO_at_llfu_input_gen );
      fmadd_op = 3'd0;
      fmadd_comb_out = out_fp;
    end
    else if ( fn == 3'd3 ) begin
      op_A = in___msg.opd_a;
      op_B = in___msg.opd_b;
      op_C = in___msg.opd_rf;
      fmadd_op = 3'd0;
  ...
  assign fmadd__clk = clk;
  assign fmadd__reset = reset;
  assign q__clk[0] = clk;
  assign q__reset[0] = reset;
  assign q__clk[1] = clk;
  assign q__reset[1] = reset;
  assign q__clk[2] = clk;
  assign q__reset[2] = reset;
  assign fmadd__control = 1'd1;
  assign fmadd__op = fmadd_op;
  assign fmadd__a = op_A[32:16];
  assign fmadd__b = op_B[32:16];
  assign fmadd__c = op_C;
  assign fmadd__roundingMode = 3'd0;
  assign unused_exception = fmadd__exceptionFlags;
  assign out_imul = fmadd__out_imul;
  assign out_fp = fmadd__out;
  assign q__enq__val[0] = in___val;
  assign in___rdy = q__enq__rdy[0];
  assign q__enq__msg[0].result = fmadd_comb_out;
  assign q__enq__msg[0].opd_b = in___msg.opd_b;
  assign q__enq__msg[0].opd_rf = in___msg.opd_rf;
  assign q__enq__val[1] = q__deq__val[0];
  assign q__deq__rdy[0] = q__enq__rdy[1];
  assign q__enq__msg[1] = q__deq__msg[0];
  assign q__enq__val[2] = q__deq__val[1];
  assign q__deq__rdy[1] = q__enq__rdy[2];
  assign q__enq__msg[2] = q__deq__msg[1];
  assign out__val = q__deq__val[2];
  assign q__deq__rdy[2] = out__rdy;
  assign out__msg = q__deq__msg[2];
  assign in_flight[0:0] = q__deq__val[0];
  assign in_flight[1:1] = q__deq__val[1];
  assign in_flight[2:2] = q__deq__val[2];
...
(
  ...
  //     s.fired_n @= s.out_val & s.out_rdy
  
  always_comb begin : riu_fired_n
    fired_n = fired;
    if ( cfg_reset ) begin
      fired_n = 1'd0;
    end
    else if ( ( ~fired ) & is_calc ) begin
      fired_n = out_val & out_rdy;
    end
  end
...
(
  ...
  output logic [0:0] in___rdy  ,
  input logic [0:0] in___val  ,
  output CgraFUOutMsg_33__result_33__is_opd_bool_true_1 out__msg  ,
  input logic [0:0] out__rdy  ,
  output logic [0:0] out__val  
);
  logic [3:0] alu_fn;
  logic [32:0] alu_opd_a;
  logic [32:0] alu_opd_b;
  CgraFUMsg_33__bca7feb9182334d7 in_msg;
  logic [0:0] in_rdy;
  logic [0:0] in_val;
  ...
  logic [0:0] in_q__clear;
  logic [0:0] in_q__clk;
  logic [0:0] in_q__is_empty;
  logic [0:0] in_q__reset;
  CgraFUMsg_33__bca7feb9182334d7 in_q__deq__msg;
  logic [0:0] in_q__deq__rdy;
  logic [0:0] in_q__deq__val;
  CgraFUMsg_33__bca7feb9182334d7 in_q__enq__msg;
  logic [0:0] in_q__enq__rdy;
  logic [0:0] in_q__enq__val;

  ValRdyNormalQueuePow2RTL__0f4fbf26539de341 in_q
  (
    .clear( in_q__clear ),
    .clk( in_q__clk ),
    .is_empty( in_q__is_empty ),
  ...
  logic [0:0] llfu__clk;
  logic [2:0] llfu__fn;
  logic [0:0] llfu__is_occupied;
  logic [0:0] llfu__reset;
  CgraLLFUMsg_33__opd_a_33__opd_b_33__opd_rf_33 llfu__in___msg;
  logic [0:0] llfu__in___rdy;
  logic [0:0] llfu__in___val;
  CgraLLFUOutMsg_33__result_33__opd_b_33__opd_rf_33 llfu__out__msg;
  logic [0:0] llfu__out__rdy;
  logic [0:0] llfu__out__val;

  LLFU llfu
  (
    .clk( llfu__clk ),
    .fn( llfu__fn ),
    .is_occupied( llfu__is_occupied ),
    .reset( llfu__reset ),
    .in___msg( llfu__in___msg ),
    .in___rdy( llfu__in___rdy ),
    .in___val( llfu__in___val ),
    .out__msg( llfu__out__msg ),
    .out__rdy( llfu__out__rdy ),
    .out__val( llfu__out__val )
  );

  //-------------------------------------------------------------
  // End of component llfu
  //-------------------------------------------------------------
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_fu_is_occupied
    is_occupied = ( in_val & in_rdy ) | llfu__is_occupied;
  end
  ...
  //       s.llfu_fn @= LLFUOp.FSUB
  //       s.is_llfu_op @= 1
  //     if s.cfg.func == CFG.FMUL:
  //       s.llfu_fn @= LLFUOp.FMUL
  //       s.is_llfu_op @= 1
  ...
  //   s.llfu.fn @= s.llfu_fn
  //   s.llfu.in_.msg.opd_a @= s.in_msg.opd_a
  // 
  //   # if (s.cfg.opcode == CFG.OP_Q_TYPE) & (s.cfg.func == CFG.MAD):
  //   #   s.llfu.in_.msg.opd_b @= s.in_msg.opd_rf
  //   #   s.llfu.in_.msg.opd_rf @= s.in_msg.opd_b
  //   # else:
  //   #   s.llfu.in_.msg.opd_b @= s.in_msg.opd_b
  ...
  always_comb begin : fu_gen_llfu_inputs
    llfu__fn = llfu_fn;
    llfu__in___msg.opd_a = in_msg.opd_a;
  ...
  always_comb begin : fu_gen_out_val
    out__val = 1'd0;
  ...
  //     if s.cfg.opcode == CFG.OP_Q_TYPE:
  //       if s.is_llfu_op:
  //         s.in_rdy @= s.llfu.in_.rdy
  //       if s.is_phi_init & s.riu.out_val:
  //         s.in_rdy @= 0
  //       if s.cfg.func == CFG.NOP:
  //         s.in_rdy @= 0
  
  always_comb begin : fu_in_q_deq
    in_rdy = 1'd0;
    if ( is_calc & ( ~cfg_reset ) ) begin
      in_rdy = out__rdy;
      if ( cfg.opcode == 1'd0 ) begin
        if ( is_llfu_op ) begin
          in_rdy = llfu__in___rdy;
        end
        if ( is_phi_init & riu__out_val ) begin
          in_rdy = 1'd0;
        end
  ...
  assign in___rdy = in_q__enq__rdy;
  assign in_q__enq__msg = in___msg;
  assign in_q__clear = cfg_reset;
  assign alu__clk = clk;
  assign alu__reset = reset;
  assign llfu__clk = clk;
  assign llfu__reset = reset;
  assign riu__clk = clk;
  assign riu__reset = reset;
  assign in_msg = in_q__deq__msg;
  assign in_val = in_q__deq__val;
  assign in_q__deq__rdy = in_rdy;
...
(
  ...
  always_ff @(posedge clk) begin : up_regenrst
    if ( reset ) begin
      out <= 33'( __const__reset_value_at_up_regenrst );
    end
    else if ( en ) begin
      out <= in_;
    end
...
(
  ...
  logic [0:0] compound_only_rf_val;
  logic [0:0] dst_to_reg;
  logic [2:0] false_dir;
  logic [0:0] is_branch;
  ...
  always_comb begin : SB_opA_rdy
    opA_rdy = fu_operands_rdy & fu_operands_val;
  end
  ...
  always_comb begin : SB_opB_rdy
    opB_rdy = fu_operands_rdy & fu_operands_val;
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_ctrl_compound_only_rf_val
    compound_only_rf_val = ( ~is_compound_op ) ? 1'd1 : rf_val;
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_ctrl_src_from_reg
    src_from_reg = ( is_opA_rf | is_opB_rf ) | is_compound_op;
  end
  ...
  //     if ~s.is_opA_rf & ~s.is_opB_rf:
  //       s.fu_operands_val @= s.opA_val & s.opB_val & s.compound_only_rf_val
  //     if ~s.is_opA_rf & s.is_opB_rf:
  //       s.fu_operands_val @= s.opA_val & s.rf_val
  //     if s.is_opA_rf & ~s.is_opB_rf:
  //       s.fu_operands_val @= s.opB_val & s.rf_val
  //     if s.is_opA_rf & s.is_opB_rf:
  //       # NOTE: Here we are assuming the FU is _blocking_. If the FU is
  //       # pipelined then we could have a RAW hazard...
  //       s.fu_operands_val @= s.rf_val
  ...
  always_comb begin : sb_fu_operand_val
    ...
    if ( ( ~is_branch ) & ( ( cfg.func == 6'd30 ) | ( cfg.func == 6'd29 ) ) ) begin
      ...
      if ( ( ~is_opA_rf ) & ( ~is_opB_rf ) ) begin
        fu_operands_val = ( opA_val & opB_val ) & compound_only_rf_val;
      end
      if ( ( ~is_opA_rf ) & is_opB_rf ) begin
        fu_operands_val = opA_val & rf_val;
      end
      if ( is_opA_rf & ( ~is_opB_rf ) ) begin
        fu_operands_val = opB_val & rf_val;
      end
      if ( is_opA_rf & is_opB_rf ) begin
        fu_operands_val = rf_val;
      end
    end
  end
  ...
  //   if s.cfg_reset | ~s.is_raw_race | s.fu_out_go:
  //     # Register values are valid in the next cycle if
  //     # (1) this is the first read (first time after cfg reset)
  //     # (2) we don't have RAW race
  //     # (3) FU has produced an output (which goes to reg if we have RAW race)
  //     s.next_rf_val @= 1
  //   elif s.fu_operands_val & s.fu_operands_rdy:
  //     # Register values are invalid in the next cycle due to RAW race if
  //     # the input operands to FU are consumed but 
  //     s.next_rf_val @= 0
  
  always_comb begin : sb_gen_next_rf_val
    next_rf_val = rf_val;
    if ( ( cfg_reset | ( ~is_raw_race ) ) | fu_out_go ) begin
      next_rf_val = 1'd1;
    end
    else if ( fu_operands_val & fu_operands_rdy ) begin
      next_rf_val = 1'd0;
    end
  end
  ...
  //     s.rf_val <<= 0
  //   else:
  //     s.rf_val <<= s.next_rf_val
  
  always_ff @(posedge clk) begin : sb_rf_val_gen
    if ( reset ) begin
      rf_val <= 1'd0;
    end
    else
...
(
  ...
  output logic [0:0] in___rdy  ,
  input logic [0:0] in___val  ,
  output logic [32:0] out__msg [0:5] ,
  ...
  //     s.sent_n @= 0
  //   else:
  //     s.sent_n @= s.sent_r | s.out_go
  
  always_comb begin : sent_next
    if ( in_go ) begin
      sent_n = 6'd0;
    end
    else
      sent_n = sent_r | out_go;
  end
...
(
  input  logic [0:0] cfg_reset ,
  input  logic [0:0] clk ,
  output CgraFUMsg_33__bca7feb9182334d7 fu_operands_msg ,
  ...
  input  logic [0:0] reset ,
  input  logic [32:0] rf_operand ,
  input logic [32:0] in___msg [0:4] ,
  output logic [0:0] in___rdy [0:4] ,
  input logic [0:0] in___val [0:4] ,
  output logic [32:0] out__msg [0:3] ,
  ...
  EagerMultiDstAdapter__Type_Bits33__noutputs_6 in_adapters__1
  (
  ...
  EagerMultiDstAdapter__Type_Bits33__noutputs_6 in_adapters__2
  (
  ...
  EagerMultiDstAdapter__Type_Bits33__noutputs_6 in_adapters__3
  (
  ...
  EagerMultiDstAdapter__Type_Bits33__noutputs_6 in_adapters__4
  (
  ...
  ValRdyMux__Type_Bits33__ninputs_6 out_muxes__1
  (
  ...
  ValRdyMux__Type_Bits33__ninputs_6 out_muxes__2
  (
  ...
  ValRdyMux__Type_Bits33__ninputs_6 out_muxes__3
  (
  ...
  assign out_muxes__in___msg[0][5] = 33'd0;
  assign out_muxes__in___val[0][5] = 1'd0;
  assign out_muxes__in___msg[1][5] = 33'd0;
  assign out_muxes__in___val[1][5] = 1'd0;
  assign out_muxes__in___msg[2][5] = 33'd0;
  assign out_muxes__in___val[2][5] = 1'd0;
  assign out_muxes__in___msg[3][5] = 33'd0;
  ...
  assign fu_operands_msg.is_faking_opA = is_faking_opA;
  assign fu_operands_msg.is_faking_opB = is_faking_opB;
...
(
  ...
  input  logic [0:0] reset ,
  input  logic [32:0] rf_operand ,
  output CgraFUMsg_33__bca7feb9182334d7 fu_in__msg  ,
  input logic [0:0] fu_in__rdy  ,
  output logic [0:0] fu_in__val  ,
  input CgraFUOutMsg_33__result_33__is_opd_bool_true_1 fu_out__msg  ,
  output logic [0:0] fu_out__rdy  ,
  input logic [0:0] fu_out__val  ,
  input logic [32:0] in___msg [0:3] ,
  output logic [0:0] in___rdy [0:3] ,
  input logic [0:0] in___val [0:3] ,
  output logic [32:0] out__msg [0:3] ,
  ...
  localparam logic [0:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_0_1_  = 1'd0;
  localparam logic [0:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_1_2_  = 1'd1;
  localparam logic [1:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_2_3_  = 2'd2;
  localparam logic [1:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_3_4_  = 2'd3;
  logic [3:0] occupancy;
  //-------------------------------------------------------------
  // Component ctrl
  //-------------------------------------------------------------
  ...
  logic [0:0] dpath__cfg_reset;
  logic [0:0] dpath__clk;
  CgraFUMsg_33__bca7feb9182334d7 dpath__fu_operands_msg;
  logic [5:0] dpath__in_adapter_mask [0:4];
  logic [0:0] dpath__in_adapter_mask_en [0:4];
  logic [0:0] dpath__is_calc;
  logic [0:0] dpath__is_faking_opA;
  logic [0:0] dpath__is_faking_opB;
  ...
  logic [0:0] dpath__reset;
  logic [32:0] dpath__rf_operand;
  logic [32:0] dpath__in___msg [0:4];
  logic [0:0] dpath__in___rdy [0:4];
  logic [0:0] dpath__in___val [0:4];
  logic [32:0] dpath__out__msg [0:3];
  ...
  (
    ...
    .is_faking_opA( dpath__is_faking_opA ),
    .is_faking_opB( dpath__is_faking_opB ),
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_ctrl_fu_out_go
    ctrl__fu_out_go = fu_out__val & fu_out__rdy;
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_0_1_
    occupancy[2'd0:2'd0] = out__val[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_0_1_ )] & out__rdy[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_0_1_ )];
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_1_2_
    occupancy[2'd1:2'd1] = out__val[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_1_2_ )] & out__rdy[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_1_2_ )];
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_2_3_
    occupancy[2'd2:2'd2] = out__val[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_2_3_ )] & out__rdy[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_2_3_ )];
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_3_4_
    occupancy[2'd3:2'd3] = out__val[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_3_4_ )] & out__rdy[2'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_sb_occupancy_3_4_ )];
  end
  ...
  assign ctrl__is_opd_bool_true = fu_out__msg.is_opd_bool_true;
  ...
  assign dpath__in___msg[4] = fu_out__msg.result;
  assign dpath__in___val[4] = fu_out__val;
  assign fu_out__rdy = dpath__in___rdy[4];
  ...
  assign fu_in__msg = dpath__fu_operands_msg;
  assign fu_in__val = ctrl__fu_operands_val;
  assign ctrl__fu_operands_rdy = fu_in__rdy;
  ...
  assign dpath__is_faking_opA = ctrl__is_faking_opA;
  assign dpath__is_faking_opB = ctrl__is_faking_opB;
...
(
  ...
  CgraFUOutMsg_33__result_33__is_opd_bool_true_1 fu__out__msg;
  ...
  logic [0:0] sb__reset;
  logic [32:0] sb__rf_operand;
  CgraFUMsg_33__bca7feb9182334d7 sb__fu_in__msg;
  logic [0:0] sb__fu_in__rdy;
  logic [0:0] sb__fu_in__val;
  CgraFUOutMsg_33__result_33__is_opd_bool_true_1 sb__fu_out__msg;
  logic [0:0] sb__fu_out__rdy;
  logic [0:0] sb__fu_out__val;
  logic [32:0] sb__in___msg [0:3];
  logic [0:0] sb__in___rdy [0:3];
  logic [0:0] sb__in___val [0:3];
  logic [32:0] sb__out__msg [0:3];
  ...
  (
    ...
    .fu_in__msg( sb__fu_in__msg ),
    .fu_in__rdy( sb__fu_in__rdy ),
    .fu_in__val( sb__fu_in__val ),
    .fu_out__msg( sb__fu_out__msg ),
    .fu_out__rdy( sb__fu_out__rdy ),
    .fu_out__val( sb__fu_out__val ),
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_PE_rc_0__dpath_fu_out_go
    fu_out_go = fu__out__val & fu__out__rdy;
  end
  ...
  assign sb__fu_out__msg = fu__out__msg;
  assign fu__out__rdy = sb__fu_out__rdy;
  assign sb__fu_out__val = fu__out__val;
...
(
  ...
  always_comb begin : upblk_output_en_accept
    enq_rdy = ( ~full ) & accept;
    deq_val = ~empty;
    wen = enq_val & enq_rdy;
  end
...
(
  ...
  logic [32:0] dpath__in___msg [0:3];
  ...
  ValRdyNormalQueuePow2RTL__65e485b98a2d2569 in_q__1
  (
  ...
  ValRdyNormalQueuePow2RTL__65e485b98a2d2569 in_q__2
  (
  ...
  ValRdyNormalQueuePow2RTL__65e485b98a2d2569 in_q__3
  (
...
(
  ...
  localparam logic [2:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_6_  = 3'd6;
  localparam logic [2:0] __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_7_  = 3'd7;
  localparam logic [1:0] __const__bytes_offset_at__lambda__s_cgra_xcel_dpath_cgra_dpath_xminion_resp_msg_data  = 2'd2;
  localparam logic [2:0] __const__num_registers_width_at__lambda__s_cgra_xcel_dpath_cgra_dpath_xminion_resp_msg_data  = 3'd6;
  ...
  logic [37:0] ME__cfg_in__msg [0:15];
  logic [0:0] ME__cfg_in__val [0:15];
  logic [37:0] ME__cfg_out__msg [0:15];
  logic [0:0] ME__cfg_out__val [0:15];
  logic [32:0] ME__in___msg [0:15];
  ...
  logic [37:0] PE_rc__cfg_in__msg [0:63];
  logic [0:0] PE_rc__cfg_in__val [0:63];
  logic [37:0] PE_rc__cfg_out__msg [0:63];
  logic [0:0] PE_rc__cfg_out__val [0:63];
  logic [32:0] PE_rc__in___msg [0:63][0:3];
  ...
  // Reduce tree
  //-------------------------------------------------------------
  // PP: Here we manually instantiate hardened cells in the
  // reduce tree in order to regularize the connections in the
  // CGRA pod.

  generate
    genvar i;
    for(i = 0; i < 8; i=i+1) begin: row_reduce
      bsg_gf_14_reduce_and_b8 rb8(
        .i(PE_rc__is_occupied[(i*8) +: 8]),
        .o(row_and_lo[i])
      );
    end
    bsg_gf_14_reduce_and_b8 col_rb8(
      .i(row_and_lo),
      .o(col_and_lo)
    );
  endgenerate
  ...
  wire center_buffered_is_calc;
  wire [7:0] col_buffered_is_calc;
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_6_
    CSRs_in[6'd6] = is_cfg_done ? 32'd1 : ( is_cfg_go | is_calc_go ) ? 32'd0 : CSRs__out[6'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_6_ )];
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_7_
    CSRs_in[6'd7] = is_calc_done ? 32'd1 : ( is_cfg_go | is_calc_go ) ? 32'd0 : CSRs__out[6'( __const__i_at__lambda__s_cgra_xcel_dpath_cgra_dpath_CSRs_in_7_ )];
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_is_calc_done
    is_calc_done = ( & all_ME_done ) & col_and_lo;
  end
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_cgra_dpath_xminion_resp_msg_data
    xminion_resp_msg.data = CSRs__out[reg_CSR_raddr[4'd7:4'( __const__bytes_offset_at__lambda__s_cgra_xcel_dpath_cgra_dpath_xminion_resp_msg_data )]];
  end
  ...
  assign CE_s__cfg_cmd = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[0] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[1] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[2] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[3] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[4] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[5] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[6] = CSRs__out[5][1:0];
  ...
  assign CE_e__cfg_cmd[7] = CSRs__out[5][1:0];
  ...
  assign PE_rc__in___msg[56][0] = 33'd0;
  ...
  assign PE_rc__in___msg[57][0] = 33'd0;
  ...
  assign PE_rc__in___msg[58][0] = 33'd0;
  ...
  assign PE_rc__in___msg[59][0] = 33'd0;
  ...
  assign PE_rc__in___msg[60][0] = 33'd0;
  ...
  assign PE_rc__in___msg[61][0] = 33'd0;
  ...
  assign PE_rc__in___msg[62][0] = 33'd0;
  ...
  assign PE_rc__in___msg[63][0] = 33'd0;
  assign PE_rc__out__rdy[63][0] = 1'd1;
  assign PE_rc__in___val[63][3] = 1'd0;
  assign PE_rc__in___msg[63][3] = 33'd0;
...
(
  ...
  assign dpath__is_cfg_go = ctrl__is_cfg_go;
  assign dpath__is_calc_go = ctrl__is_calc_go;
...
(
  ...
  always_comb begin : _lambda__s_cgra_xcel_dpath_scratchpad_banks_0__adapter_minion_resp_msg_data
    minion__resp__msg.data = ( ~reg_req_wen ) ? rdata : 32'd0;
  end
...
(
  ...
  assign minion__resp__msg[0].addr[3:2] = 2'd0;
  assign minion__resp__msg[0].addr[1:0] = 2'd0;
  ...
  assign minion__resp__msg[1].addr[3:2] = 2'd1;
  assign minion__resp__msg[1].addr[1:0] = 2'd0;
  ...
  assign minion__resp__msg[2].addr[3:2] = 2'd2;
  assign minion__resp__msg[2].addr[1:0] = 2'd0;
  ...
  assign minion__resp__msg[3].addr[3:2] = 2'd3;
  assign minion__resp__msg[3].addr[1:0] = 2'd0;
...
(
  ...
  // PyMTL Lambda Block Source
  // At /work/global/pp482/test/cgra-src/src/pymtl3_net/mmxbar/Table.py:90
  ...
  // PyMTL Update Block Source
  // At /work/global/pp482/test/cgra-src/src/pymtl3_net/mmxbar/Table.py:73
  // @update
  // def up_alloc_rdy():
  //   s.alloc.rdy @= 0
  ...
  // PyMTL Update Block Source
  // At /work/global/pp482/test/cgra-src/src/pymtl3_net/mmxbar/Table.py:52
  // @update
  ...
  // PyMTL Update Block Source
  // At /work/global/pp482/test/cgra-src/src/pymtl3_net/mmxbar/Table.py:80
  // @update
  // def up_dealloc_rdy():
  //   s.dealloc.rdy @= 0
  //   for i in range( num_entries ):
  ...
  // PyMTL Update Block Source
  // At /work/global/pp482/test/cgra-src/src/pymtl3_net/mmxbar/Table.py:61
  // @update_ff
  // def up_avail_idx_r():
  //   if s.reset:
  ...
  always_ff @(posedge clk) begin : up_entry_r_valid_r
    if ( reset ) begin
      for ( int unsigned i = 1'd0; i < 3'( __const__num_entries_at_up_entry_r_valid_r ); i += 1'd1 ) begin
        valid_r[2'(i)] <= 1'd0;
        entry_r[2'(i)] <= 7'd0;
      end
    end
...
(
  ...
  always_comb begin : up_get_en
    for ( int unsigned i = 1'd0; i < 5'( __const__num_inports_at_up_get_en ); i += 1'd1 )
      get_en[5'(i)] = give__en & ( mux__sel == 5'(i) );
  end
...
// Full name: HBEndpointRXAdapter__hb_params_<hammerblade.params.HBParams object at 0x7ffa220ef6d0>__xcel_params_CGRAParams: base_addr_bound:16384, base_addr_register:0, base_addr_scratchpad:256, cfg_nwords:1, cfg_type:<class 'pymtl3.datatypes.bits_import.Bits32'>, data_width:32, enable_FP:True, enable_debug_ports:False, llfu_stages:4, me_cfg_type:<class 'types.MEConfigMsg_8x8'>, mul_cycles:0, ncols:8, nrows:8, nspads:4, num_remote_masters:4, pe_cfg_type:<class 'types.PEConfigMsg_8x8'>, remote_master_addr_width:28, remote_master_data_width_factor:1, rf_nregs:4, spad_data_width:32, spad_mask_size:0, spad_num_entries:1024, trace_verbosity:0
// At /work/global/pp482/test/cgra-src/src/hammerblade/HBEndpointRXAdapter.py

module HBEndpointRXAdapter__74f0e97c7d7d4c29
(
  input  logic [0:0] clk ,
...
// Full name: HBEndpointTXAdapter__hb_params_<hammerblade.params.HBParams object at 0x7ffa220ef6d0>__xcel_params_CGRAParams: base_addr_bound:16384, base_addr_register:0, base_addr_scratchpad:256, cfg_nwords:1, cfg_type:<class 'pymtl3.datatypes.bits_import.Bits32'>, data_width:32, enable_FP:True, enable_debug_ports:False, llfu_stages:4, me_cfg_type:<class 'types.MEConfigMsg_8x8'>, mul_cycles:0, ncols:8, nrows:8, nspads:4, num_remote_masters:4, pe_cfg_type:<class 'types.PEConfigMsg_8x8'>, remote_master_addr_width:28, remote_master_data_width_factor:1, rf_nregs:4, spad_data_width:32, spad_mask_size:0, spad_num_entries:1024, trace_verbosity:0
// At /work/global/pp482/test/cgra-src/src/hammerblade/HBEndpointTXAdapter.py

module HBEndpointTXAdapter__74f0e97c7d7d4c29
(
  input  logic [0:0] clk ,
  input  logic [6:0] my_x ,
  input  logic [6:0] my_y ,
...
// Full name: HBEndpointCGRAXcel__hb_params_<hammerblade.params.HBParams object at 0x7ffa220ef6d0>__xcel_params_CGRAParams: base_addr_bound:16384, base_addr_register:0, base_addr_scratchpad:256, cfg_nwords:1, cfg_type:<class 'pymtl3.datatypes.bits_import.Bits32'>, data_width:32, enable_FP:True, enable_debug_ports:False, llfu_stages:4, me_cfg_type:<class 'types.MEConfigMsg_8x8'>, mul_cycles:0, ncols:8, nrows:8, nspads:4, num_remote_masters:4, pe_cfg_type:<class 'types.PEConfigMsg_8x8'>, remote_master_addr_width:28, remote_master_data_width_factor:1, rf_nregs:4, spad_data_width:32, spad_mask_size:0, spad_num_entries:1024, trace_verbosity:0
...
(
  ...
  HBEndpointRXAdapter__74f0e97c7d7d4c29 rx
  (
    .clk( rx__clk ),
    .my_x( rx__my_x ),
    .my_y( rx__my_y ),
  ...
  HBEndpointTXAdapter__74f0e97c7d7d4c29 tx
  (
    .clk( tx__clk ),
    .my_x( tx__my_x ),
    .my_y( tx__my_y ),
