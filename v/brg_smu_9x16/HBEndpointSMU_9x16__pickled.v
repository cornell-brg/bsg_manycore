...
// PyMTL BitStruct HBEndpointPacket__e2750e7da3a33fe6 Definition
typedef struct packed {
  logic [27:0] addr;
  logic [1:0] op;
  logic [3:0] op_ex;
...
(
  ...
  input  logic [3:0] req_src_x_cord ,
...
(
  ...
  HBEndpointPacket__e2750e7da3a33fe6 req_packet;
  //-------------------------------------------------------------
  // Component arb
  //-------------------------------------------------------------
  ...
  assign req_pkt[15:12] = req_packet.src_y_cord;
  assign req_pkt[47:16] = req_packet.payload;
  assign req_pkt[52:48] = req_packet.reg_id;
  assign req_pkt[56:53] = req_packet.op_ex;
  assign req_pkt[58:57] = req_packet.op;
  assign req_pkt[86:59] = req_packet.addr;
